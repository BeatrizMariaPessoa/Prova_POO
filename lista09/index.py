...
from templates.cadastroUI import Cadastrar_cliente
...
class IndexUI:
    ...
    def sidebar():
      op = st.sidebar.selectbox("Menu", ["Manter Clientes", "Manter Serviços", "Manter Agenda", "Abrir Agenda do Dia", "Cadastro"])
      ...
      if op == "Cadastro": Cadastrar_cliente.main()
